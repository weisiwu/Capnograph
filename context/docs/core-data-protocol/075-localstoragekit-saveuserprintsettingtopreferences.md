...
- 关键字段 / 方法：`hospital_name`、`report_name`、`is_output_pdf`、`pdf_template_mode`、`pdf_watermark_enabled`、`pdf_watermark_text`、`pdf_watermark_opacity`、`pdf_event_context_seconds`、`show_trend_chart` 等。

## 关键字段 / 方法

- 主要字段、方法或协议值：`hospital_name`、`report_name`、`is_output_pdf`、`pdf_template_mode`、`pdf_watermark_enabled`、`pdf_watermark_text`、`pdf_watermark_opacity`、`pdf_event_context_seconds`、`show_trend_chart` 等。
