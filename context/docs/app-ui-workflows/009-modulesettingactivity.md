...
定位入口：`context/entity-id-mapping.md`（L83）。
领域：页面。

## 实体定位

- 实体：ModuleSettingActivity
- ID / 别名：MODULE_CONFIG_PAGE, 模块设置, 模块参数
- 源文件：`app/src/main/java/com/wldmedical/capnoeasy/pages/ModuleSettingActivity.kt`
- 原始补充上下文：`.cursor/rules/project-memory.mdc`
- 备注：大气压、窒息时间和 O2 补偿设置

## 补充职责

模块参数页，用 RangeSelector 展示大气压并设置窒息时间、O2 补偿，保存时调用 updateNoBreathAndCompensation。

## 关键 ID / 别名

MODULE_CONFIG_PAGE, 模块设置, 模块参数
