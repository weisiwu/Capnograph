...
定位入口：`context/entity-id-mapping.md`（L101）。
领域：常量。

## 实体定位

- 实体：PageScene.HISTORY_LIST_PAGE
- ID / 别名：constant_history_records, 历史记录
...
constant_history_records, 历史记录

## 关键字段 / 方法

- 主要实体或方法：PageScene.HISTORY_LIST_PAGE
