# PageScene.ALERT_CONFIG_PAGE

来源批次：应用入口、页面、UI 与状态实体补充。
定位入口：`context/entity-id-mapping.md`（L97）。
领域：常量。

## 实体定位

- 实体：PageScene.ALERT_CONFIG_PAGE
- ID / 别名：constant_alert_setting, 报警设置
...
constant_alert_setting, 报警设置

## 关键字段 / 方法

- 主要实体或方法：PageScene.ALERT_CONFIG_PAGE
