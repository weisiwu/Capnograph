# PageScene.MODULE_CONFIG_PAGE

来源批次：应用入口、页面、UI 与状态实体补充。
定位入口：`context/entity-id-mapping.md`（L99）。
领域：常量。

## 实体定位

- 实体：PageScene.MODULE_CONFIG_PAGE
- ID / 别名：constant_module_setting, 模块设置
...
constant_module_setting, 模块设置

## 关键字段 / 方法

- 主要实体或方法：PageScene.MODULE_CONFIG_PAGE
