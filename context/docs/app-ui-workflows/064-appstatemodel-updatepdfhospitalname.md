# AppStateModel.updatePdfHospitalName

来源批次：应用入口、页面、UI 与状态实体补充。
定位入口：`context/entity-id-mapping.md`（L168）。
领域：状态函数。

## 实体定位

- 实体：`AppStateModel.updatePdfHospitalName`
- ID / 别名：hospital name, PDF医院名
...
hospital name, PDF医院名

## 关键字段 / 方法

- 主要实体或方法：`AppStateModel.updatePdfHospitalName`
