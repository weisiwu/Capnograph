# PageScene.SYSTEM_CONFIG_PAGE

来源批次：应用入口、页面、UI 与状态实体补充。
定位入口：`context/entity-id-mapping.md`（L96）。
领域：常量。

## 实体定位

- 实体：PageScene.SYSTEM_CONFIG_PAGE
- ID / 别名：constant_system_setting, 系统设置
...
constant_system_setting, 系统设置

## 关键字段 / 方法

- 主要实体或方法：PageScene.SYSTEM_CONFIG_PAGE
