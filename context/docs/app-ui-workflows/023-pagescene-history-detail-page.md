...
定位入口：`context/entity-id-mapping.md`（L102）。
领域：常量。

## 实体定位

- 实体：PageScene.HISTORY_DETAIL_PAGE
- ID / 别名：constant_record_detail, 记录详情
...
constant_record_detail, 记录详情

## 关键字段 / 方法

- 主要实体或方法：PageScene.HISTORY_DETAIL_PAGE
