...
定位入口：`context/entity-id-mapping.md`（L95）。
领域：常量。

## 实体定位

- 实体：PageScene.DEVICES_LIST_PAGE
- ID / 别名：constant_nearby_devices, 附近设备
...
constant_nearby_devices, 附近设备

## 关键字段 / 方法

- 主要实体或方法：PageScene.DEVICES_LIST_PAGE
